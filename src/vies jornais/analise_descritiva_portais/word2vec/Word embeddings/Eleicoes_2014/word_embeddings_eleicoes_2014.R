...
we_noticias_estadao <- cria_word_embedding(tema, n_layers, analogias, noticias_estadao_tema, path_saida)
...
#we_comentarios_estadao <- cria_word_embedding(tema, n_layers, analogias, comentarios_estadao_tema, path_saida)
...
we_noticias_folha <- cria_word_embedding(tema, n_layers, analogias, noticias_folha_tema, path_saida)
...
we_comentarios_folha <- cria_word_embedding(tema, n_layers, analogias, comentarios_folha_tema, path_saida)