...
#### Noticias
```{r}
we_noticias_estadao <- read.binary.vectors("../Word embeddings/Eleicoes_2014/embeddings/eleicoes_2014_estadao.bin")

tema = "estadao_noticias_eleicao_2014"
palavras_normalizadas_estadao <- computa_distancias(we_noticias_estadao, tema, MIN_TAMANHO, referencia_1, referencia_2, entity, path_saida)
direct_bias_detection(palavras_normalizadas_estadao[[1]], referencia_1, referencia_2, entity)
```

### Folha
#### Noticias
```{r}
we_noticias_folha <- read.binary.vectors("../Word embeddings/Eleicoes_2014/embeddings/eleicoes_2014_folha.bin")
...
direct_bias_detection(palavras_normalizadas_folha[[1]], referencia_1, referencia_2, entity)
```

#### Comentarios
```{r}
we_comentarios_folha <- read.binary.vectors("../Word embeddings/Eleicoes_2014/embeddings/folha_comentarios_eleicao_2014.bin")
...
direct_bias_detection(palavras_normalizadas_folha_comentarios[[1]], referencia_1, referencia_2, entity)
```